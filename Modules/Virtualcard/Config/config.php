...
return [
    ...
    'menu_config' => [
        'name' => __('Virtual Card'),
        'label' => 'Virtual Card',
        'icon' => megaMenuSvg('virtualcard'),
        'route' => 'login',
        'condition' => (module('ManualVirtualcard') && isActive('ManualVirtualcard')) || (module('StripeVirtualcard') && isActive('StripeVirtualcard'))
    ],
];
