    ...
    <div class="main-auth-div">
        <div class="row min-vh-100 g-0">
            <div class="col-md-6 col-xl-5 hide-small-device position-relative overflow-hidden" style="min-height: 100vh;">
                <img class="img img-fluid w-100 h-100 position-absolute top-0 start-0" src="{{ asset('public/frontend/templates/images/login/loginimage.png') }}" style="object-fit: cover; object-position: center;" alt="Sign In">
